...
searchInput.addEventListener("keypress", searchOnKeyDown);
...
function search() {
    ...
    if (input.length < 4) {
        results.innerHTML = "<h6>Please use at least four characters!</h6>";
        return;
    }

    const matches = lyrics.match(buildRegex(input));
    if (matches) {
        const uniqueMatches = new Set(matches);
        var html = "";
        for (const match of uniqueMatches) {
            html +='<figure class="bg-light px-3 py-3">' +
        ...
        results.innerHTML = "<h6>No matches found...</h6>";
    }
}
...
const lyrics = `It feels like a perfect night to dress up like hipsters
...
I've been spending the last eight months
Thinking all love ever does is break and burn and end
But on a Wednesday in a cafÃ©, I watched it begin again
...
I get so high, oh
Every time you'reâevery time you're loving me
You're loving me
Trip of my life, oh
Every time you'reâevery time you're touching me
You're touching me
...
It rains when you're here and it rains when you're gone
I was there when you said, "Forever and always"
You didn't mean it baby, I don't think so, oh
...
And I make it lookâohâso easy
...
You say
"Your roommate's cheap-ass screw top rosÃ©
That's how"
...
And all you're ever gonna be is mean
Why you gotta be so mean?
Hey Apple Music, this is Taylor Swift
Midnights tells the stories of thirteen sleepless nights scattered throughout my life
I hope you like it and, wherever you are, you'll meet me at midnight
...
RosÃ© flowing with your chosen family
...
And the town said, "How did a middle-class divorcÃ©e do it?"
...
And I will get you aâget you alone
...
Maybe I was naÃ¯ve, got lost in your eyes
And never really had a chance
My mistake, I didn't know to be in love
You had to fight to have the upper hand
...
But you're taking shots at me like it's PatrÃ³n
